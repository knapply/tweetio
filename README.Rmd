...
Not only is `tweetio::read_tweets()` more efficient, it's able to successfully parse much more of the data (`r scales::comma(nrow(tweetio_df))` vs `r scales::comma(nrow(tweetio_df))` rows).
