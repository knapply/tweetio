...
We're more interested in handling much larger data sets, like this one that was also obtained using `rtweet::stream_tweets()`. The JSON has been compressed to an 124 Mb .gz file (1.2 Gb uncompressed).
...
Fortunately, `{tweetio}` can handle these situations by dropping invalid JSON on the fly.
