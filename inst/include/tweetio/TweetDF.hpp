...
class TweetDF {
    ...
    TweetDF(const R_xlen_t& n_vals) {
        user_id                      = vec_chr(n_vals, na_chr);
        status_id                    = vec_chr(n_vals, na_chr);
        created_at                   = vec_chr(n_vals, na_chr);
        screen_name                  = vec_chr(n_vals, na_chr);
        text                         = vec_chr(n_vals, na_chr);
        source                       = vec_chr(n_vals, na_chr);
        reply_to_status_id           = vec_chr(n_vals, na_chr);
        reply_to_user_id             = vec_chr(n_vals, na_chr);
        reply_to_screen_name         = vec_chr(n_vals, na_chr);
        is_quote                     = vec_lgl(n_vals, na_lgl);
        is_retweeted                 = vec_lgl(n_vals, na_lgl);
        ...
        lang                         = vec_chr(n_vals, na_chr);

        quoted_status_id             = vec_chr(n_vals, na_chr); 
        quoted_text                  = vec_chr(n_vals, na_chr); 
        quoted_created_at            = vec_chr(n_vals, na_chr); 
        quoted_source                = vec_chr(n_vals, na_chr); 
        quoted_favorite_count        = vec_int(n_vals, na_int); 
        quoted_retweet_count         = vec_int(n_vals, na_int); 
        quoted_user_id               = vec_chr(n_vals, na_chr); 
        quoted_screen_name           = vec_chr(n_vals, na_chr); 
        quoted_name                  = vec_chr(n_vals, na_chr); 
        quoted_followers_count       = vec_int(n_vals, na_int); 
        quoted_friends_count         = vec_int(n_vals, na_int); 
        quoted_statuses_count        = vec_int(n_vals, na_int); 
        quoted_location              = vec_chr(n_vals, na_chr);
        quoted_description           = vec_chr(n_vals, na_chr);
        quoted_verified              = vec_lgl(n_vals, na_lgl);

        retweet_status_id            = vec_chr(n_vals, na_chr);
        retweet_text                 = vec_chr(n_vals, na_chr);
        retweet_created_at           = vec_chr(n_vals, na_chr);
        retweet_source               = vec_chr(n_vals, na_chr);
        retweet_favorite_count       = vec_int(n_vals, na_int);
        retweet_retweet_count        = vec_int(n_vals, na_int);
        retweet_user_id              = vec_chr(n_vals, na_chr);
        retweet_screen_name          = vec_chr(n_vals, na_chr);
        retweet_name                 = vec_chr(n_vals, na_chr);
        retweet_followers_count      = vec_int(n_vals, na_int);
        retweet_friends_count        = vec_int(n_vals, na_int);
        retweet_statuses_count       = vec_int(n_vals, na_int);
        retweet_location             = vec_chr(n_vals, na_chr);
        retweet_description          = vec_chr(n_vals, na_chr);
        retweet_verified             = vec_lgl(n_vals, na_lgl);

        place_url                    = vec_chr(n_vals, na_chr);
        place_name                   = vec_chr(n_vals, na_chr);
        place_full_name              = vec_chr(n_vals, na_chr);
        place_type                   = vec_chr(n_vals, na_chr);
        country                      = vec_chr(n_vals, na_chr);
        country_code                 = vec_chr(n_vals, na_chr);
        bbox_coords                  = Rcpp::List( n_vals);

        retweet_place_url            = vec_chr(n_vals, na_chr);
        retweet_place_name           = vec_chr(n_vals, na_chr);
        retweet_place_full_name      = vec_chr(n_vals, na_chr);
        retweet_place_type           = vec_chr(n_vals, na_chr);
        retweet_country              = vec_chr(n_vals, na_chr);
        retweet_country_code         = vec_chr(n_vals, na_chr);
        retweet_bbox_coords          = Rcpp::List( n_vals);

        quoted_place_url            = vec_chr(n_vals, na_chr);
        quoted_place_name           = vec_chr(n_vals, na_chr);
        quoted_place_full_name      = vec_chr(n_vals, na_chr);
        quoted_place_type           = vec_chr(n_vals, na_chr);
        quoted_country              = vec_chr(n_vals, na_chr);
        quoted_country_code         = vec_chr(n_vals, na_chr);
        quoted_bbox_coords          = Rcpp::List( n_vals);

        name                         = vec_chr(n_vals, na_chr);
        location                     = vec_chr(n_vals, na_chr);
        description                  = vec_chr(n_vals, na_chr);
        url                          = vec_chr(n_vals, na_chr);
        protected_                   = vec_lgl(n_vals, na_lgl);
        followers_count              = vec_int(n_vals, na_int);
        friends_count                = vec_int(n_vals, na_int);
        listed_count                 = vec_int(n_vals, na_int);
        statuses_count               = vec_int(n_vals, na_int);
        favourites_count             = vec_int(n_vals, na_int);
        account_created_at           = vec_chr(n_vals, na_chr);
        verified                     = vec_lgl(n_vals, na_lgl);
        account_lang                 = vec_chr(n_vals, na_chr);
        profile_banner_url           = vec_chr(n_vals, na_chr);
        profile_image_url            = vec_chr(n_vals, na_chr);
        timestamp_ms                 = vec_dbl(n_vals, NA_REAL);
        contributors_enabled         = vec_lgl(n_vals, na_lgl);
