...
//     Rcpp::List to_r() {
//         const R_xlen_t max_length = this->current_index;
...
//         const R_xlen_t n_rows = max_length;
...
//     PulseMeta(const std::size_t& n_vals) {
...
//         for (R_xlen_t i = 0; i < max_length; ++i) {
...
//             const R_xlen_t n_rows = length_tester.length();
