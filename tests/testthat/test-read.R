test_that("reading rtweet stream works", {
  target_schema <- list(
    user_id = "character", status_id = "character", 
    created_at = c("POSIXct", "POSIXt"), screen_name = "character", 
    text = "character", source = "character", 
    ...
    retweet_bbox_coords = "list", quoted_place_url = "character", 
