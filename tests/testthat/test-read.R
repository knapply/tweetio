test_that("reading rtweet stream works", {
  target_schema <-
    list(user_id = "character", status_id = "character", created_at = c("POSIXct", "POSIXt"),
         ...
         is_retweeted = "logical", lang = "character", name = "character",
         ...
         account_lang = "character", profile_banner_url = "character",
         profile_image_url = "character", contributors_enabled = "logical",
         hashtags = "list", urls_expanded_url = "list", media_url = "list",
         media_type = "list", mentions_user_id = "list", mentions_screen_name = "list",
         quoted_status_id = "character", quoted_text = "character",
         quoted_created_at = c("POSIXct", "POSIXt"), quoted_source = "character",
         quoted_favorite_count = "integer", quoted_quoted_count = "integer",
         ...
         retweet_status_id = "character", retweet_text = "character",
         retweet_created_at = c("POSIXct", "POSIXt"), retweet_source = "character",
         retweet_favorite_count = "integer", retweet_retweet_count = "integer",
         retweet_user_id = "character", retweet_screen_name = "character",
         retweet_name = "character", retweet_followers_count = "integer",
         retweet_friends_count = "integer", retweet_statuses_count = "integer",
         retweet_location = "character", retweet_description = "character",
         ...
         bbox_coords = "list", quoted_place_url = "character", quoted_place_name = "character",
         quoted_place_full_name = "character", quoted_place_type = "character",
         quoted_country = "character", quoted_country_code = "character",
         quoted_bbox_coords = "list", retweet_place_url = "character",
  ...
  expect_s3_class(
    read_tweets(example_tweet_file()),
    "data.table"
  )
  ...
  if (requireNamespace("tibble", quietly = TRUE)) {
    expect_s3_class(
      read_tweets(example_tweet_file(), as_tibble = TRUE),
      "tbl_df"
    )
  }
})
