test_that("reading rtweet stream works", {
  target_schema <- list(
    ...
    bbox_coords = "list", 
    retweet_place_url = "character",
    retweet_place_name = "character", 
    retweet_place_full_name = "character", 
    retweet_place_type = "character", 
    retweet_country = "character",
    retweet_country_code = "character", 
    retweet_bbox_coords = "list", 
    quoted_place_url = "character", 
    quoted_place_name = "character", 
    quoted_place_full_name = "character", 
    quoted_place_type = "character", 
    quoted_country = "character", 
    quoted_country_code = "character", 
